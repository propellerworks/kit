...
const argv = yargs.argv,
  ...
  paths = {
    src: {
      ...
      scripts: [ './src/js/**/*.js', './src/js/bundles/*.js' ],
...
export const watchCode = () => {
  ...
  watch(paths.src.bundles, bundler);
...
export const development = series(cleanFiles, sprites, parallel(html, styles, bundler, scripts, images, favs),
  parallel(watchCode, server));

export const prod = series(cleanFiles, sprites, serverConfig, html, styles, bundler, scripts, images, favs);
